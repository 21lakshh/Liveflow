        ...
        >
          <defs>
            <radialGradient id="matrix-pixel-on" cx="50%" cy="50%" r="50%">
              ...
              <stop offset="70%" stopColor={palette.on} stopOpacity="0.8" />
              <stop offset="100%" stopColor={palette.on} stopOpacity="0.6" />
            </radialGradient>
            <radialGradient id="matrix-pixel-off" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor={palette.off} stopOpacity="0.15" />
              <stop offset="100%" stopColor={palette.off} stopOpacity="0.05" />
            </radialGradient>
            ...
            row.map((value, colIndex) => {
              ...
              return (
                <circle
                  ...
                  filter={opacity > 0.5 ? "url(#matrix-glow)" : undefined}
                  style={{
